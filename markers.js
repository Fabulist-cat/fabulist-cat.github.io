...
const MARKERS = [
...

  {
    ...
    glowColor:   "#d9c634",
    description: "Колись, до побудови Далвартського каналу, саме тут протікав величний Едельстром. Коли ріку переспрямували в нове русло, містечко у переправи занепало, перетворившись на всього лиш одне з передмість Далварту.",
    link:        "locations/placeholder.html",
    label:       false,
    labelPermanent: false
  },
